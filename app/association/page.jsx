const Association = () => {
  return (
    <div className='grid grid-cols-2 place-content-center gap-4 p-6'>

      {/* Ligne 1 */}
      <div className="card bg-base-100 shadow-sm">
        <div className="card-body">
          <h2 className="card-title">Qui sommes-nous ?</h2>
          <p>Nous sommes l'association "Kids are the futur", créée en 2021, et forte de 111 adhérents sur l'année scolaire 2022-2023.</p>
