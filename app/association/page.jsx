    ...
    <div className='place-content-center p-6'>
      <div className="card lg:card-side bg-neutral shadow-sm mb-8">
        <figure className="card-img lg:max-w-1/2">
          <img
            src="association/quisommesnous.jpg"
            alt="QuiSommesNous?" />
        </figure>
        <div className="card-body lg:max-w-1/2">
          <h2 className="card-title">Qui sommes-nous ?</h2>
          <p className="text-justify">L’association KIDS ARE THE FUTURE / Ecole MTB BBOYING SCHOOL, a vu le jour en septembre 2018. Crée par Audrey TREVISAN championne de France et championne du monde de Breaking, et Eric ESPINOSA.</p>
          <p className="text-justify">L’école est 100% Hip-hop et enseigne les différentes disciplines ainsi que les valeurs de cette culture.</p>
        </div>
      </div>
      ...
      <div className="card lg:card-side bg-neutral shadow-sm mb-8">
        <div className="card-body lg:max-w-1/2">
          ...
          <p className="text-justify">L’ASSOCIATION Située sur Montauban, KIDS ARE THE FUTURE est activement impliqué depuis 2018 dans la promotion et le développement de la culture hip-hop auprès des publics et des institutions. </p>
          <p className="text-justify">Notre association a pour cœur d’activité la valorisation de notre culture et ses différentes formes d’expression. L'association KIDS ARE THE FUTURE s'adapte aux besoins socio-culturels du département. Elle crée également des événements Nationaux, Européens et Internationaux (Mtb battle, Breaking History, Hip-hop for hapiness en Asie du Sud Est).</p>
          <p className="text-justify">Au quotidien, elle met en place des actions de médiation culturelle, développe les pratiques artistiques amateurs en danses Hip-Hop et s’engage dans des actions de renforcement du lien social par la danse, avec le désir permanent de rendre la culture hip hop accessible au plus grand nombre. (Contrat de Ville, QPV) </p>
          <p className="text-justify">Tout au long de l’année, Kids are the future organise aussi de nombreux événements destinés à un public de plus en plus large. Cours de danse, stages, festivals, expositions, spectacles... autant d’événements qui valorisent notre culture auprès de publics divers avec pour seul mot d’ordre : « le partage »</p>
        </div>
        <figure className="card-img lg:max-w-1/2">
          <img
            src="association/mission.jpg"
            alt="Mission" />
        </figure>
      </div>
