...
const Evenements = () => {
  ...
  return (
    <div className="grid lg:grid-cols-3 gap-8 m-8">
      <CarteEvent titre="MTB BATTLE" desc="Championnat amateur de danse Hip-hop." img="BattleJuin_01.jpg" date="7 juin 2025"/>
      ...
      <CarteEvent titre="BREAKING HISTORY" desc="Événement NATIONAL de BREAKING. Prochaine édition le samedi 29 novembre 2025. Conférence, Stage, Battle." img="BreakingHistory_01.jpg" date="29 novembre 2025"/>
