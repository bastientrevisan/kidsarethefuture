    ...
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10">
      ...
      <nav>
        ...
        <div className="grid grid-flow-col gap-4">
          <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/mtbbboyingschool/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a target="_blank" rel="noopener noreferrer" href="https://fr-fr.facebook.com/mtbbboying/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
